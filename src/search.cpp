...
//Scale 2048
int l1Weights[8][6] = {{284, 137, 11, -77, 108, 181},      {35, 70, -53, -38, 146, -107},
                       {26, -128, 7, -12, -201, 53},       {-202, 200, -148, -121, 116, 75},
                       {116, 106, -9, 59, 80, -248},       {-142, -40, 131, -204, -38, -48},
                       {-343, -180, -89, 255, -138, -185}, {130, -161, -48, -21, -102, -97}};

int l1Biases[6] = {46, -20, 22, 78, -48, 32};

int outputWeights[6][3] = {{117, 494, -60}, {115, 323, 54},   {-17, 121, 244},
                           {-147, 87, 84},  {225, -145, 263}, {66, -29, -176}};

int outputBiases[3] = {-4, 154, 290};
