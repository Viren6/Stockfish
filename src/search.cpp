...
namespace {
  ...
  int inputScales[24][10][2] = {
    {{-490, 1217}, {196, 165}, {19, 226}, {522, 540}, {504, 547}, {-103, 428}, {504, 619}, {130, -305}, {54, -850}, {-248, -123}},
    {{35, 1008}, {-197, 311}, {438, -249}, {-70, -238}, {51, 687}, {-365, -133}, {221, 951}, {-237, -80}, {455, 256}, {181, 32}},
    {{78, -725}, {28, -1585}, {599, 277}, {357, 778}, {1147, -11}, {-260, 647}, {-280, -703}, {-460, 620}, {486, -456}, {138, 419}},
    {{-581, -968}, {-760, -1648}, {1053, -182}, {632, 566}, {-397, 781}, {-358, -300}, {434, 179}, {-157, 431}, {-890, 900}, {-164, 241}},
    {{58, -2042}, {57, -435}, {-264, -20}, {743, 413}, {-229, 12}, {203, -731}, {1057, -170}, {-235, 587}, {306, 811}, {-140, -221}},
    {{-1363, 1209}, {-535, 70}, {461, -184}, {-194, 579}, {-137, -13}, {626, -391}, {-427, -224}, {-69, 224}, {-431, 342}, {300, 47}},
    {{533, -457}, {394, -446}, {-569, -1194}, {30, 316}, {198, 397}, {441, -583}, {-596, -173}, {278, -538}, {38, 1175}, {295, 79}},
    {{-315, -1338}, {-377, -701}, {-1133, -375}, {-567, -292}, {419, -163}, {-541, -190}, {-20, 68}, {277, 364}, {314, -149}, {-111, 207}},
    {{-447, 714}, {335, 812}, {280, 376}, {-101, 1007}, {-316, -65}, {-236, -408}, {620, -362}, {661, -284}, {457, -409}, {61, 220}},
    {{-311, 1534}, {559, 522}, {465, -345}, {819, -303}, {129, 2000}, {60, -100}, {44, 473}, {-329, -696}, {-552, 356}, {-134, -228}},
    {{165, -443}, {245, 213}, {236, 79}, {499, -361}, {378, -388}, {175, -258}, {-24, -144}, {-506, -602}, {59, 378}, {-89, 203}},
    {{-26, -90}, {-327, 929}, {172, -287}, {-127, -136}, {531, -730}, {-152, -37}, {-13, 495}, {-639, -706}, {693, 1113}, {-33, -97}},
    {{75, 573}, {-81, -671}, {-86, -9}, {-1057, 372}, {-385, 711}, {222, 502}, {293, -289}, {242, 399}, {427, 1216}, {278, -199}},
    {{21, -516}, {120, -1285}, {-102, -106}, {-5, 711}, {120, 432}, {-333, 97}, {531, 443}, {279, -257}, {726, -163}, {-43, 266}},
    {{38, -307}, {1, 1365}, {124, 86}, {-318, -331}, {5, 824}, {373, 1238}, {90, -42}, {-740, 289}, {342, -158}, {185, -109}},
    {{369, 178}, {-194, -101}, {-544, 279}, {-449, -98}, {300, -510}, {-183, -117}, {-853, -1071}, {1358, 458}, {88, 177}, {322, -409}},
    {{-55, 53}, {140, -926}, {460, 67}, {183, 496}, {81, -1883}, {192, 620}, {-376, -849}, {-396, 1478}, {-481, 113}, {-104, -265}},
    {{-67, 328}, {354, -890}, {278, -615}, {-717, -558}, {-1081, 93}, {-734, -773}, {-517, -68}, {805, -220}, {-763, 672}, {158, -25}},
    {{-1028, 284}, {39, 217}, {153, -526}, {-63, -503}, {202, -556}, {222, 990}, {-330, 159}, {-246, -745}, {-775, -715}, {-211, 39}},
    {{-286, 42}, {148, 320}, {786, -172}, {-510, -193}, {325, 611}, {670, 457}, {-325, -381}, {-939, 94}, {156, -106}, {28, 0}},
    {{-773, -157}, {23, -61}, {347, 91}, {54, 171}, {-896, -1147}, {156, -145}, {-77, -145}, {-728, -857}, {-286, 1112}, {-86, 131}},
    {{681, -320}, {-438, -457}, {-552, 1014}, {-50, 686}, {-334, 81}, {897, -580}, {121, 185}, {-182, -662}, {-172, 348}, {-60, -21}},
    {{746, -310}, {-495, 108}, {577, 265}, {-246, 116}, {26, 243}, {-699, -257}, {-596, -313}, {-200, 127}, {671, -273}, {47, 19}},
    {{430, 112}, {-65, 4}, {-78, -586}, {243, 398}, {224, 225}, {171, 168}, {-289, -215}, {14, -71}, {163, -125}, {71, 213}}
  };
  ...
  int statScoreInput[24] = { -73, 131, -111, -149, -99, -180, -180, -44, -213, 39, 127, -201, -156, 30, -84, -332, -43, 243, 266, -8, -223, -215, -145, 736};

  int biases[2][24] = { { -1990, -1726, 3153, 4226, 3994, 5040, 5373, 6183, -2728, -2859, 121, 72, 33, 105, 62, -239, 57, -1854, -347, 29, 128, 44, 62, 43},
                         {-423, -51, -274, -14, 207, 124, -256, -324, -112, 13, 423, -463, 74, 238, -432, 179, 26, 283, -185, -254, -8, 303, 22, -104} };
  int slopes[2][2][24] = { {{167, 272, 2007, 1007, 1182, 2483, 1123, 895, 138, 275, 88, 249, 396, 211, 175, 77, 484, 460, 24, 494, 229, 123, 453, 53},
  ...
  int calculateFinalLayers(bool W_IN[10], int depth, int singular, int statScore, int nodeType, int ttValue, int ttMove, int n) {
      int outputSum = 0;
      for (int i = 0; i < 24; ++i) {
          int sum = 0;
          for (int j = 0; j < 10; ++j) {
  ...
  int Store[2][2][2][2][2][2][2][2][2][2][2][5][3][3][5][4][15];

  int Lookup(bool W_IN[10], int depth, int singular, int statScore, int nodeType, int ttValue, int ttMove, int n) {
      if (Store[n][W_IN[0]][W_IN[1]][W_IN[2]][W_IN[3]][W_IN[4]][W_IN[5]][W_IN[6]][W_IN[7]][W_IN[8]][W_IN[9]][ttMove]
          [ttValue][nodeType][depth][singular][statScore] == 0) {
          Store[n][W_IN[0]][W_IN[1]][W_IN[2]][W_IN[3]][W_IN[4]][W_IN[5]][W_IN[6]][W_IN[7]][W_IN[8]][W_IN[9]][ttMove]
              [ttValue][nodeType][depth][singular][statScore] = calculateFinalLayers(W_IN, depth, singular, statScore, nodeType, ttValue, ttMove, n);
      }
      return Store[n][W_IN[0]][W_IN[1]][W_IN[2]][W_IN[3]][W_IN[4]][W_IN[5]][W_IN[6]][W_IN[7]][W_IN[8]][W_IN[9]][ttMove]
