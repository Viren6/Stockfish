...
//Scale 2048
int l1Weights[8][8] = {
  {70, -7, -37, -20, -25, 4, 73, -20},      {31, -8, -3, -26, -7, -48, 12, -55},
  {-10, -81, -23, 56, 24, -22, 14, 46},     {14, -2, -6, -5, 4, 11, 37, 26},
  {60, -10, -43, -45, -4, -84, 40, 76},     {-95, 0, 60, -7, 14, -33, -17, -40},
  {-45, -57, -11, -71, -39, -24, -66, -92}, {13, 30, -19, 49, -109, 70, -45, -85}};

int l1Biases[8] = {-2, 27, -9, 15, 41, -53, -50, -65};

int outputWeights[8][3] = {{14, 51, -13}, {70, 74, -71},  {108, -19, -41}, {136, 33, -71},
                           {85, 61, -49}, {128, -21, 24}, {72, 95, 12},    {250, 46, 13}};

int outputBiases[3] = {58, 62, -61};
...
int* Search::Worker::extensionNN(bool reductionConditions[8]) { 
    ...
    for (int i = 0; i < 3; i++)
    {
        ...
        int outClipped      = (outInt > 32) ? outInt : 32;
