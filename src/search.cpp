...
namespace {
  ...
  void SetValues() {
      inputScales[0][0][0] = 107;
      inputScales[0][0][1] = 1236;
      inputScales[0][1][0] = 241;
      inputScales[0][1][1] = 860;
      inputScales[0][2][0] = -631;
      inputScales[0][2][1] = 909;
      inputScales[0][3][0] = 86;
      inputScales[0][3][1] = 302;
      inputScales[0][4][0] = -305;
      inputScales[0][4][1] = 141;
      inputScales[0][5][0] = -90;
      inputScales[0][5][1] = 52;
      inputScales[0][6][0] = -223;
      inputScales[0][6][1] = 235;
      inputScales[0][7][0] = 97;
      inputScales[0][7][1] = 189;
      inputScales[0][8][0] = 79;
      inputScales[0][8][1] = 123;
      inputScales[0][9][0] = -143;
      inputScales[0][9][1] = 4;
      inputScales[0][10][0] = 53;
      inputScales[0][10][1] = -168;
      inputScales[0][11][0] = 192;
      inputScales[0][11][1] = 295;
      inputScales[1][0][0] = 41;
      inputScales[1][0][1] = 1100;
      inputScales[1][1][0] = -430;
      inputScales[1][1][1] = 617;
      inputScales[1][2][0] = -195;
      inputScales[1][2][1] = 488;
      inputScales[1][3][0] = -121;
      inputScales[1][3][1] = 988;
      inputScales[1][4][0] = 76;
      inputScales[1][4][1] = -267;
      inputScales[1][5][0] = 29;
      inputScales[1][5][1] = -264;
      inputScales[1][6][0] = -258;
      inputScales[1][6][1] = 438;
      inputScales[1][7][0] = -105;
      inputScales[1][7][1] = -201;
      inputScales[1][8][0] = 202;
      inputScales[1][8][1] = -52;
      inputScales[1][9][0] = 106;
      inputScales[1][9][1] = 37;
      inputScales[1][10][0] = -86;
      inputScales[1][10][1] = 110;
      inputScales[1][11][0] = 359;
      inputScales[1][11][1] = 51;
      inputScales[2][0][0] = -432;
      inputScales[2][0][1] = -1052;
      inputScales[2][1][0] = 187;
      inputScales[2][1][1] = -973;
      inputScales[2][2][0] = -1076;
      inputScales[2][2][1] = -70;
      inputScales[2][3][0] = -449;
      inputScales[2][3][1] = 369;
      inputScales[2][4][0] = 189;
      inputScales[2][4][1] = -913;
      inputScales[2][5][0] = -146;
      inputScales[2][5][1] = 3;
      inputScales[2][6][0] = 293;
      inputScales[2][6][1] = -357;
      inputScales[2][7][0] = 227;
      inputScales[2][7][1] = 73;
      inputScales[2][8][0] = 59;
      inputScales[2][8][1] = 219;
      inputScales[2][9][0] = 161;
      inputScales[2][9][1] = 410;
      inputScales[2][10][0] = 182;
      inputScales[2][10][1] = 73;
      inputScales[2][11][0] = 133;
      inputScales[2][11][1] = -516;
      inputScales[3][0][0] = -3;
      inputScales[3][0][1] = -1028;
      inputScales[3][1][0] = 99;
      inputScales[3][1][1] = -1290;
      inputScales[3][2][0] = -994;
      inputScales[3][2][1] = 340;
      inputScales[3][3][0] = -194;
      inputScales[3][3][1] = -174;
      inputScales[3][4][0] = -7;
      inputScales[3][4][1] = -1075;
      inputScales[3][5][0] = -101;
      inputScales[3][5][1] = -590;
      inputScales[3][6][0] = 0;
      inputScales[3][6][1] = -113;
      inputScales[3][7][0] = 56;
      inputScales[3][7][1] = 231;
      inputScales[3][8][0] = 448;
      inputScales[3][8][1] = -38;
      inputScales[3][9][0] = -486;
      inputScales[3][9][1] = -20;
      inputScales[3][10][0] = 46;
      inputScales[3][10][1] = -248;
      inputScales[3][11][0] = -58;
      inputScales[3][11][1] = 127;
      inputScales[4][0][0] = 115;
      inputScales[4][0][1] = -1084;
      inputScales[4][1][0] = 78;
      inputScales[4][1][1] = -913;
      inputScales[4][2][0] = -420;
      inputScales[4][2][1] = 166;
      inputScales[4][3][0] = 290;
      inputScales[4][3][1] = 8;
      inputScales[4][4][0] = -796;
      inputScales[4][4][1] = -59;
      inputScales[4][5][0] = 112;
      inputScales[4][5][1] = -245;
      inputScales[4][6][0] = -401;
      inputScales[4][6][1] = -709;
      inputScales[4][7][0] = -126;
      inputScales[4][7][1] = -117;
      inputScales[4][8][0] = -242;
      inputScales[4][8][1] = -172;
      inputScales[4][9][0] = -109;
      inputScales[4][9][1] = -91;
      inputScales[4][10][0] = 556;
      inputScales[4][10][1] = 72;
      inputScales[4][11][0] = 138;
      inputScales[4][11][1] = 118;
      inputScales[5][0][0] = 146;
      inputScales[5][0][1] = -972;
      inputScales[5][1][0] = -429;
      inputScales[5][1][1] = -790;
      inputScales[5][2][0] = -1090;
      inputScales[5][2][1] = -52;
      inputScales[5][3][0] = -145;
      inputScales[5][3][1] = 321;
      inputScales[5][4][0] = -1133;
      inputScales[5][4][1] = -392;
      inputScales[5][5][0] = 266;
      inputScales[5][5][1] = -66;
      inputScales[5][6][0] = 330;
      inputScales[5][6][1] = -646;
      inputScales[5][7][0] = 24;
      inputScales[5][7][1] = -1057;
      inputScales[5][8][0] = -31;
      inputScales[5][8][1] = 277;
      inputScales[5][9][0] = 270;
      inputScales[5][9][1] = 34;
      inputScales[5][10][0] = -401;
      inputScales[5][10][1] = -162;
      inputScales[5][11][0] = -123;
      inputScales[5][11][1] = 59;
      inputScales[6][0][0] = -20;
      inputScales[6][0][1] = -1036;
      inputScales[6][1][0] = 78;
      inputScales[6][1][1] = -687;
      inputScales[6][2][0] = -1225;
      inputScales[6][2][1] = 59;
      inputScales[6][3][0] = -13;
      inputScales[6][3][1] = 23;
      inputScales[6][4][0] = -1147;
      inputScales[6][4][1] = -318;
      inputScales[6][5][0] = -124;
      inputScales[6][5][1] = -388;
      inputScales[6][6][0] = -1043;
      inputScales[6][6][1] = 245;
      inputScales[6][7][0] = 154;
      inputScales[6][7][1] = 58;
      inputScales[6][8][0] = -404;
      inputScales[6][8][1] = -1179;
      inputScales[6][9][0] = 64;
      inputScales[6][9][1] = -83;
      inputScales[6][10][0] = 298;
      inputScales[6][10][1] = 29;
      inputScales[6][11][0] = 277;
      inputScales[6][11][1] = 9;
      inputScales[7][0][0] = -136;
      inputScales[7][0][1] = -802;
      inputScales[7][1][0] = 385;
      inputScales[7][1][1] = -1098;
      inputScales[7][2][0] = -1008;
      inputScales[7][2][1] = 260;
      inputScales[7][3][0] = 317;
      inputScales[7][3][1] = -47;
      inputScales[7][4][0] = -1013;
      inputScales[7][4][1] = 190;
      inputScales[7][5][0] = 17;
      inputScales[7][5][1] = 249;
      inputScales[7][6][0] = -1186;
      inputScales[7][6][1] = -124;
      inputScales[7][7][0] = 60;
      inputScales[7][7][1] = -24;
      inputScales[7][8][0] = -1396;
      inputScales[7][8][1] = -99;
      inputScales[7][9][0] = -137;
      inputScales[7][9][1] = -999;
      inputScales[7][10][0] = 91;
      inputScales[7][10][1] = 2;
      inputScales[7][11][0] = 245;
      inputScales[7][11][1] = 90;
      inputScales[8][0][0] = 117;
      inputScales[8][0][1] = 957;
      inputScales[8][1][0] = 1157;
      inputScales[8][1][1] = 66;
      inputScales[8][2][0] = -427;
      inputScales[8][2][1] = -59;
      inputScales[8][3][0] = 242;
      inputScales[8][3][1] = 142;
      inputScales[8][4][0] = 91;
      inputScales[8][4][1] = 373;
      inputScales[8][5][0] = -147;
      inputScales[8][5][1] = 230;
      inputScales[8][6][0] = 349;
      inputScales[8][6][1] = -486;
      inputScales[8][7][0] = -519;
      inputScales[8][7][1] = -166;
      inputScales[8][8][0] = 50;
      inputScales[8][8][1] = 89;
      inputScales[8][9][0] = -290;
      inputScales[8][9][1] = -19;
      inputScales[8][10][0] = -197;
      inputScales[8][10][1] = 1044;
      inputScales[8][11][0] = -336;
      inputScales[8][11][1] = 487;
      inputScales[9][0][0] = -335;
      inputScales[9][0][1] = 1085;
      inputScales[9][1][0] = 615;
      inputScales[9][1][1] = 299;
      inputScales[9][2][0] = -412;
      inputScales[9][2][1] = -321;
      inputScales[9][3][0] = -103;
      inputScales[9][3][1] = -94;
      inputScales[9][4][0] = 41;
      inputScales[9][4][1] = 23;
      inputScales[9][5][0] = 206;
      inputScales[9][5][1] = 144;
      inputScales[9][6][0] = 155;
      inputScales[9][6][1] = -316;
      inputScales[9][7][0] = -24;
      inputScales[9][7][1] = 163;
      inputScales[9][8][0] = 42;
      inputScales[9][8][1] = -266;
      inputScales[9][9][0] = -133;
      inputScales[9][9][1] = 255;
      inputScales[9][10][0] = 950;
      inputScales[9][10][1] = -12;
      inputScales[9][11][0] = -244;
      inputScales[9][11][1] = 1041;
      biases[0][0] = -1982;
      biases[0][1] = -2061;
      biases[0][2] = 3179;
      biases[0][3] = 3998;
      ...
      slopes[1][1][8] = 17;
      slopes[1][1][9] = 4;
      outputSlopes[0][0] = 941;
      outputSlopes[0][1] = 888;
      outputSlopes[1][0] = 24;
      outputSlopes[1][1] = 9;
      residualScale = 559;
      residualAdjustment = 10;
      residualBaseline = -103;
  }
