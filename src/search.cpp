...
namespace {
    ...
    const int reductionAdjustment = 214; const int baseImprovingReductionAdjustment = -24012; const int ttClamp = 2049; //Removed baseReductionScale
    ...
    const int baseReductionAdjustment = 961; const int baseReductionDeltaScale = 911; //Update tune ranges and c values
    const int reductionTableScale = 1304;
  ...
  int reduction(int improvement, Depth d, int mn, Value delta, Value rootDelta) {
    ...
    int reduction = (r + baseReductionAdjustment - int(delta) * baseReductionDeltaScale / int(rootDelta));
    if(improvement <= improvementLower)
        ...
        std::min(improvementAdjustment - improvement * improvementScale / 1024, improvementUpper) / 1024 / 1024;
    return reduction;
  }
