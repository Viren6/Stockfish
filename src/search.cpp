...
namespace {
  ...
  void SetValues() {
      inputScales[0][0][0] = 141;
      inputScales[0][0][1] = 1211;
      inputScales[0][1][0] = 293;
      inputScales[0][1][1] = 913;
      inputScales[0][2][0] = -598;
      inputScales[0][2][1] = 866;
      inputScales[0][3][0] = 65;
      inputScales[0][3][1] = 297;
      inputScales[0][4][0] = -232;
      inputScales[0][4][1] = 134;
      inputScales[0][5][0] = 69;
      inputScales[0][5][1] = 37;
      inputScales[0][6][0] = -179;
      inputScales[0][6][1] = 316;
      inputScales[0][7][0] = 183;
      inputScales[0][7][1] = 161;
      inputScales[0][8][0] = 94;
      inputScales[0][8][1] = 64;
      inputScales[0][9][0] = -113;
      inputScales[0][9][1] = -42;
      inputScales[0][10][0] = 35;
      inputScales[0][10][1] = -211;
      inputScales[0][11][0] = 193;
      inputScales[0][11][1] = 249;
      inputScales[1][0][0] = -16;
      inputScales[1][0][1] = 1104;
      inputScales[1][1][0] = -485;
      inputScales[1][1][1] = 650;
      inputScales[1][2][0] = -239;
      inputScales[1][2][1] = 479;
      inputScales[1][3][0] = -189;
      inputScales[1][3][1] = 1036;
      inputScales[1][4][0] = 143;
      inputScales[1][4][1] = -264;
      inputScales[1][5][0] = 12;
      inputScales[1][5][1] = -250;
      inputScales[1][6][0] = -220;
      inputScales[1][6][1] = 422;
      inputScales[1][7][0] = -160;
      inputScales[1][7][1] = -209;
      inputScales[1][8][0] = 244;
      inputScales[1][8][1] = 31;
      inputScales[1][9][0] = 55;
      inputScales[1][9][1] = 20;
      inputScales[1][10][0] = -147;
      inputScales[1][10][1] = 87;
      inputScales[1][11][0] = 292;
      inputScales[1][11][1] = 9;
      inputScales[2][0][0] = -467;
      inputScales[2][0][1] = -1048;
      inputScales[2][1][0] = 207;
      inputScales[2][1][1] = -980;
      inputScales[2][2][0] = -1090;
      inputScales[2][2][1] = -26;
      inputScales[2][3][0] = -493;
      inputScales[2][3][1] = 329;
      inputScales[2][4][0] = 263;
      inputScales[2][4][1] = -852;
      inputScales[2][5][0] = -92;
      inputScales[2][5][1] = -84;
      inputScales[2][6][0] = 316;
      inputScales[2][6][1] = -397;
      inputScales[2][7][0] = 194;
      inputScales[2][7][1] = 3;
      inputScales[2][8][0] = 91;
      inputScales[2][8][1] = 248;
      inputScales[2][9][0] = 253;
      inputScales[2][9][1] = 444;
      inputScales[2][10][0] = 207;
      inputScales[2][10][1] = 24;
      inputScales[2][11][0] = 65;
      inputScales[2][11][1] = -410;
      inputScales[3][0][0] = 57;
      inputScales[3][0][1] = -953;
      inputScales[3][1][0] = 28;
      inputScales[3][1][1] = -1302;
      inputScales[3][2][0] = -1101;
      inputScales[3][2][1] = 347;
      inputScales[3][3][0] = -187;
      inputScales[3][3][1] = -129;
      inputScales[3][4][0] = 61;
      inputScales[3][4][1] = -1072;
      inputScales[3][5][0] = -97;
      inputScales[3][5][1] = -615;
      inputScales[3][6][0] = 20;
      inputScales[3][6][1] = -59;
      inputScales[3][7][0] = -2;
      inputScales[3][7][1] = 205;
      inputScales[3][8][0] = 461;
      inputScales[3][8][1] = 77;
      inputScales[3][9][0] = -466;
      inputScales[3][9][1] = 80;
      inputScales[3][10][0] = 83;
      inputScales[3][10][1] = -326;
      inputScales[3][11][0] = -154;
      inputScales[3][11][1] = 178;
      inputScales[4][0][0] = 107;
      inputScales[4][0][1] = -1022;
      inputScales[4][1][0] = 47;
      inputScales[4][1][1] = -995;
      inputScales[4][2][0] = -412;
      inputScales[4][2][1] = 128;
      inputScales[4][3][0] = 232;
      inputScales[4][3][1] = -3;
      inputScales[4][4][0] = -841;
      inputScales[4][4][1] = -68;
      inputScales[4][5][0] = 186;
      inputScales[4][5][1] = -274;
      inputScales[4][6][0] = -396;
      inputScales[4][6][1] = -716;
      inputScales[4][7][0] = -132;
      inputScales[4][7][1] = -117;
      inputScales[4][8][0] = -205;
      inputScales[4][8][1] = -155;
      inputScales[4][9][0] = -39;
      inputScales[4][9][1] = -99;
      inputScales[4][10][0] = 547;
      inputScales[4][10][1] = 125;
      inputScales[4][11][0] = 183;
      inputScales[4][11][1] = 61;
      inputScales[5][0][0] = 91;
      inputScales[5][0][1] = -1046;
      inputScales[5][1][0] = -376;
      inputScales[5][1][1] = -778;
      inputScales[5][2][0] = -1173;
      inputScales[5][2][1] = 1;
      inputScales[5][3][0] = -109;
      inputScales[5][3][1] = 273;
      inputScales[5][4][0] = -1097;
      inputScales[5][4][1] = -396;
      inputScales[5][5][0] = 226;
      inputScales[5][5][1] = 1;
      inputScales[5][6][0] = 275;
      inputScales[5][6][1] = -685;
      inputScales[5][7][0] = 99;
      inputScales[5][7][1] = -1028;
      inputScales[5][8][0] = 35;
      inputScales[5][8][1] = 336;
      inputScales[5][9][0] = 221;
      inputScales[5][9][1] = -36;
      inputScales[5][10][0] = -426;
      inputScales[5][10][1] = -100;
      inputScales[5][11][0] = -132;
      inputScales[5][11][1] = 126;
      inputScales[6][0][0] = -99;
      inputScales[6][0][1] = -1020;
      inputScales[6][1][0] = 98;
      inputScales[6][1][1] = -628;
      inputScales[6][2][0] = -1145;
      inputScales[6][2][1] = 12;
      inputScales[6][3][0] = -12;
      inputScales[6][3][1] = 20;
      inputScales[6][4][0] = -1157;
      inputScales[6][4][1] = -352;
      inputScales[6][5][0] = -126;
      inputScales[6][5][1] = -315;
      inputScales[6][6][0] = -1048;
      inputScales[6][6][1] = 223;
      inputScales[6][7][0] = 118;
      inputScales[6][7][1] = 135;
      inputScales[6][8][0] = -388;
      inputScales[6][8][1] = -1188;
      inputScales[6][9][0] = -55;
      inputScales[6][9][1] = -117;
      inputScales[6][10][0] = 376;
      inputScales[6][10][1] = -17;
      inputScales[6][11][0] = 306;
      inputScales[6][11][1] = 5;
      inputScales[7][0][0] = -93;
      inputScales[7][0][1] = -836;
      inputScales[7][1][0] = 417;
      inputScales[7][1][1] = -1144;
      inputScales[7][2][0] = -1001;
      inputScales[7][2][1] = 233;
      inputScales[7][3][0] = 255;
      inputScales[7][3][1] = -53;
      inputScales[7][4][0] = -1007;
      inputScales[7][4][1] = 170;
      inputScales[7][5][0] = 103;
      inputScales[7][5][1] = 235;
      inputScales[7][6][0] = -1225;
      inputScales[7][6][1] = -197;
      inputScales[7][7][0] = 82;
      inputScales[7][7][1] = -87;
      inputScales[7][8][0] = -1322;
      inputScales[7][8][1] = -115;
      inputScales[7][9][0] = -165;
      inputScales[7][9][1] = -994;
      inputScales[7][10][0] = 168;
      inputScales[7][10][1] = 76;
      inputScales[7][11][0] = 198;
      inputScales[7][11][1] = 73;
      inputScales[8][0][0] = 207;
      inputScales[8][0][1] = 963;
      inputScales[8][1][0] = 1147;
      inputScales[8][1][1] = 102;
      inputScales[8][2][0] = -377;
      inputScales[8][2][1] = -45;
      inputScales[8][3][0] = 247;
      inputScales[8][3][1] = 179;
      inputScales[8][4][0] = 138;
      inputScales[8][4][1] = 379;
      inputScales[8][5][0] = -144;
      inputScales[8][5][1] = 230;
      inputScales[8][6][0] = 275;
      inputScales[8][6][1] = -527;
      inputScales[8][7][0] = -467;
      inputScales[8][7][1] = -177;
      inputScales[8][8][0] = 30;
      inputScales[8][8][1] = 70;
      inputScales[8][9][0] = -227;
      inputScales[8][9][1] = 80;
      inputScales[8][10][0] = -221;
      inputScales[8][10][1] = 974;
      inputScales[8][11][0] = -298;
      inputScales[8][11][1] = 508;
      inputScales[9][0][0] = -275;
      inputScales[9][0][1] = 1103;
      inputScales[9][1][0] = 575;
      inputScales[9][1][1] = 229;
      inputScales[9][2][0] = -378;
      inputScales[9][2][1] = -285;
      inputScales[9][3][0] = -6;
      inputScales[9][3][1] = 4;
      inputScales[9][4][0] = 20;
      inputScales[9][4][1] = 105;
      inputScales[9][5][0] = 96;
      inputScales[9][5][1] = 201;
      inputScales[9][6][0] = 242;
      inputScales[9][6][1] = -250;
      inputScales[9][7][0] = 28;
      inputScales[9][7][1] = 237;
      inputScales[9][8][0] = 94;
      inputScales[9][8][1] = -181;
      inputScales[9][9][0] = -130;
      inputScales[9][9][1] = 225;
      inputScales[9][10][0] = 882;
      inputScales[9][10][1] = 38;
      inputScales[9][11][0] = -242;
      inputScales[9][11][1] = 1033;
      biases[0][0] = -1977;
      biases[0][1] = -2059;
      biases[0][2] = 3209;
      biases[0][3] = 3999;
      ...
      slopes[1][1][8] = 26;
      slopes[1][1][9] = 13;
      outputSlopes[0][0] = 954;
      outputSlopes[0][1] = 879;
      outputSlopes[1][0] = 19;
      outputSlopes[1][1] = 6;
      residualScale = 535;
      residualAdjustment = -8;
      residualBaseline = -86;
  }
