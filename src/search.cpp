...
//Scale 2048
int l1Weights[6][6] = {{481, 752, 245, 614, 939, 749},    {172, -179, -349, -86, 157, 29},
                       {211, 103, -66, -406, 193, 49},    {59, -62, -18, 421, 97, -112},
                       {-107, -30, -92, -228, -194, -19}, {-148, 372, 52, -144, 16, 34}};

int l1Biases[6] = {-341, -101, -480, -114, -150, -5};

int outputWeights[6][3] = {{-227, 776, 313}, {171, 964, 509},   {68, 386, 95},
                           {230, 670, 366},  {-199, 1073, 311}, {14, 721, 60}};

int outputBiases[3] = {-37, 534, -79};
