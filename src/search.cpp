...
namespace {
  ...
  void SetValues() {
      inputScales[0][0][0] = 104;
      inputScales[0][0][1] = 1193;
      inputScales[0][1][0] = 315;
      inputScales[0][1][1] = 972;
      inputScales[0][2][0] = -659;
      inputScales[0][2][1] = 872;
      inputScales[0][3][0] = 75;
      inputScales[0][3][1] = 283;
      inputScales[0][4][0] = -320;
      inputScales[0][4][1] = 143;
      inputScales[0][5][0] = -116;
      inputScales[0][5][1] = -19;
      inputScales[0][6][0] = -167;
      inputScales[0][6][1] = 252;
      inputScales[0][7][0] = 85;
      inputScales[0][7][1] = 246;
      inputScales[0][8][0] = 131;
      inputScales[0][8][1] = 191;
      inputScales[0][9][0] = -201;
      inputScales[0][9][1] = 57;
      inputScales[0][10][0] = 72;
      inputScales[0][10][1] = -149;
      inputScales[0][11][0] = 255;
      inputScales[0][11][1] = 274;
      inputScales[1][0][0] = 76;
      inputScales[1][0][1] = 1047;
      inputScales[1][1][0] = -424;
      inputScales[1][1][1] = 625;
      inputScales[1][2][0] = -168;
      inputScales[1][2][1] = 520;
      inputScales[1][3][0] = -174;
      inputScales[1][3][1] = 960;
      inputScales[1][4][0] = 88;
      inputScales[1][4][1] = -218;
      inputScales[1][5][0] = -9;
      inputScales[1][5][1] = -323;
      inputScales[1][6][0] = -274;
      inputScales[1][6][1] = 354;
      inputScales[1][7][0] = -94;
      inputScales[1][7][1] = -193;
      inputScales[1][8][0] = 181;
      inputScales[1][8][1] = -75;
      inputScales[1][9][0] = 73;
      inputScales[1][9][1] = 39;
      inputScales[1][10][0] = -103;
      inputScales[1][10][1] = 121;
      inputScales[1][11][0] = 304;
      inputScales[1][11][1] = -9;
      inputScales[2][0][0] = -384;
      inputScales[2][0][1] = -1057;
      inputScales[2][1][0] = 214;
      inputScales[2][1][1] = -961;
      inputScales[2][2][0] = -1004;
      inputScales[2][2][1] = -128;
      inputScales[2][3][0] = -484;
      inputScales[2][3][1] = 486;
      inputScales[2][4][0] = 253;
      inputScales[2][4][1] = -925;
      inputScales[2][5][0] = -246;
      inputScales[2][5][1] = 19;
      inputScales[2][6][0] = 247;
      inputScales[2][6][1] = -364;
      inputScales[2][7][0] = 267;
      inputScales[2][7][1] = 61;
      inputScales[2][8][0] = 132;
      inputScales[2][8][1] = 210;
      inputScales[2][9][0] = 131;
      inputScales[2][9][1] = 394;
      inputScales[2][10][0] = 110;
      inputScales[2][10][1] = 52;
      inputScales[2][11][0] = 148;
      inputScales[2][11][1] = -528;
      inputScales[3][0][0] = -54;
      inputScales[3][0][1] = -1089;
      inputScales[3][1][0] = -5;
      inputScales[3][1][1] = -1291;
      inputScales[3][2][0] = -1016;
      inputScales[3][2][1] = 326;
      inputScales[3][3][0] = -262;
      inputScales[3][3][1] = -152;
      inputScales[3][4][0] = 13;
      inputScales[3][4][1] = -1067;
      inputScales[3][5][0] = -126;
      inputScales[3][5][1] = -538;
      inputScales[3][6][0] = 92;
      inputScales[3][6][1] = -81;
      inputScales[3][7][0] = 87;
      inputScales[3][7][1] = 308;
      inputScales[3][8][0] = 471;
      inputScales[3][8][1] = -29;
      inputScales[3][9][0] = -453;
      inputScales[3][9][1] = -41;
      inputScales[3][10][0] = 59;
      inputScales[3][10][1] = -156;
      inputScales[3][11][0] = -127;
      inputScales[3][11][1] = 43;
      inputScales[4][0][0] = 200;
      inputScales[4][0][1] = -1200;
      inputScales[4][1][0] = 52;
      inputScales[4][1][1] = -917;
      inputScales[4][2][0] = -400;
      inputScales[4][2][1] = 180;
      inputScales[4][3][0] = 290;
      inputScales[4][3][1] = 81;
      inputScales[4][4][0] = -823;
      inputScales[4][4][1] = -30;
      inputScales[4][5][0] = 124;
      inputScales[4][5][1] = -254;
      inputScales[4][6][0] = -443;
      inputScales[4][6][1] = -745;
      inputScales[4][7][0] = -123;
      inputScales[4][7][1] = -169;
      inputScales[4][8][0] = -254;
      inputScales[4][8][1] = -106;
      inputScales[4][9][0] = -37;
      inputScales[4][9][1] = -176;
      inputScales[4][10][0] = 532;
      inputScales[4][10][1] = 61;
      inputScales[4][11][0] = 183;
      inputScales[4][11][1] = 127;
      inputScales[5][0][0] = 191;
      inputScales[5][0][1] = -892;
      inputScales[5][1][0] = -490;
      inputScales[5][1][1] = -875;
      inputScales[5][2][0] = -1135;
      inputScales[5][2][1] = -111;
      inputScales[5][3][0] = -188;
      inputScales[5][3][1] = 370;
      inputScales[5][4][0] = -1154;
      inputScales[5][4][1] = -397;
      inputScales[5][5][0] = 271;
      inputScales[5][5][1] = 9;
      inputScales[5][6][0] = 330;
      inputScales[5][6][1] = -669;
      inputScales[5][7][0] = 92;
      inputScales[5][7][1] = -1073;
      inputScales[5][8][0] = -72;
      inputScales[5][8][1] = 235;
      inputScales[5][9][0] = 264;
      inputScales[5][9][1] = 0;
      inputScales[5][10][0] = -378;
      inputScales[5][10][1] = -133;
      inputScales[5][11][0] = -72;
      inputScales[5][11][1] = 113;
      inputScales[6][0][0] = -38;
      inputScales[6][0][1] = -1052;
      inputScales[6][1][0] = 58;
      inputScales[6][1][1] = -633;
      inputScales[6][2][0] = -1268;
      inputScales[6][2][1] = 30;
      inputScales[6][3][0] = 38;
      inputScales[6][3][1] = 4;
      inputScales[6][4][0] = -1134;
      inputScales[6][4][1] = -334;
      inputScales[6][5][0] = -198;
      inputScales[6][5][1] = -435;
      inputScales[6][6][0] = -994;
      inputScales[6][6][1] = 278;
      inputScales[6][7][0] = 93;
      inputScales[6][7][1] = 37;
      inputScales[6][8][0] = -394;
      inputScales[6][8][1] = -1186;
      inputScales[6][9][0] = 49;
      inputScales[6][9][1] = -94;
      inputScales[6][10][0] = 254;
      inputScales[6][10][1] = 15;
      inputScales[6][11][0] = 255;
      inputScales[6][11][1] = 32;
      inputScales[7][0][0] = -176;
      inputScales[7][0][1] = -815;
      inputScales[7][1][0] = 240;
      inputScales[7][1][1] = -1084;
      inputScales[7][2][0] = -1030;
      inputScales[7][2][1] = 292;
      inputScales[7][3][0] = 269;
      inputScales[7][3][1] = -131;
      inputScales[7][4][0] = -1008;
      inputScales[7][4][1] = 183;
      inputScales[7][5][0] = -41;
      inputScales[7][5][1] = 283;
      inputScales[7][6][0] = -1231;
      inputScales[7][6][1] = -117;
      inputScales[7][7][0] = 41;
      inputScales[7][7][1] = 42;
      inputScales[7][8][0] = -1380;
      inputScales[7][8][1] = -91;
      inputScales[7][9][0] = -93;
      inputScales[7][9][1] = -1029;
      inputScales[7][10][0] = -2;
      inputScales[7][10][1] = 67;
      inputScales[7][11][0] = 309;
      inputScales[7][11][1] = 89;
      inputScales[8][0][0] = 130;
      inputScales[8][0][1] = 912;
      inputScales[8][1][0] = 1219;
      inputScales[8][1][1] = 95;
      inputScales[8][2][0] = -369;
      inputScales[8][2][1] = -113;
      inputScales[8][3][0] = 261;
      inputScales[8][3][1] = 172;
      inputScales[8][4][0] = 69;
      inputScales[8][4][1] = 297;
      inputScales[8][5][0] = -92;
      inputScales[8][5][1] = 199;
      inputScales[8][6][0] = 306;
      inputScales[8][6][1] = -464;
      inputScales[8][7][0] = -549;
      inputScales[8][7][1] = -187;
      inputScales[8][8][0] = 22;
      inputScales[8][8][1] = 105;
      inputScales[8][9][0] = -306;
      inputScales[8][9][1] = 7;
      inputScales[8][10][0] = -193;
      inputScales[8][10][1] = 1100;
      inputScales[8][11][0] = -352;
      inputScales[8][11][1] = 537;
      inputScales[9][0][0] = -287;
      inputScales[9][0][1] = 1025;
      inputScales[9][1][0] = 565;
      inputScales[9][1][1] = 300;
      inputScales[9][2][0] = -427;
      inputScales[9][2][1] = -376;
      inputScales[9][3][0] = -64;
      inputScales[9][3][1] = -141;
      inputScales[9][4][0] = -32;
      inputScales[9][4][1] = 13;
      inputScales[9][5][0] = 169;
      inputScales[9][5][1] = 156;
      inputScales[9][6][0] = 107;
      inputScales[9][6][1] = -297;
      inputScales[9][7][0] = -14;
      inputScales[9][7][1] = 100;
      inputScales[9][8][0] = 145;
      inputScales[9][8][1] = -264;
      inputScales[9][9][0] = -33;
      inputScales[9][9][1] = 282;
      inputScales[9][10][0] = 1067;
      inputScales[9][10][1] = 97;
      inputScales[9][11][0] = -367;
      inputScales[9][11][1] = 1076;
      biases[0][0] = -1948;
      biases[0][1] = -2068;
      biases[0][2] = 3152;
      biases[0][3] = 3974;
      ...
      slopes[1][1][8] = 31;
      slopes[1][1][9] = 9;
      outputSlopes[0][0] = 942;
      outputSlopes[0][1] = 878;
      outputSlopes[1][0] = 8;
      outputSlopes[1][1] = 28;
      residualScale = 566;
      residualAdjustment = -15;
      residualBaseline = -104;
  }
