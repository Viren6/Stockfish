...
namespace {
  ...
  const int biases[10] = { -2048, -2048, 3072, 4096, 4096, 5120, 5120, 6144, -2048, -3072 };
  const int slopes[2][10] = {{0   , 0   , 2048, 1024, 1024, 2048, 1024, 1024, 0   , 0    },
                             {1024, 1024, 0   , 0   , 0   , 0   , 0   , 0   , 1024, 1024 }};

  const int outputBias = 0;
  const int outputSlopes[2] = {1024, 1024};
