...
Value Eval::evaluate(const Eval::NNUE::Networks& networks, const Position& pos, int optimism, bool pv) {
    ...
    Value nnue = (smallNet || pv) ? networks.small.evaluate(pos, true, &nnueComplexity, psqtOnly)
